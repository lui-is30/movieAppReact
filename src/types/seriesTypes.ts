...
export type TVDetailType={
    ...
    last_episode_to_air:{id:number,name:string,overview:string,vote_average:number,vote_count:number,air_date:string,episode_number:number,production_code:string;runtime:number,season_number:number,show_id:number,still_path:string};
    name:string;
